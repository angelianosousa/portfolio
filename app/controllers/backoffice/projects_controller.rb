class Backoffice::ProjectsController < BackofficeController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:title, :visible_on_home, :thumbnail, :description, :objectives, :learns, :production_link, :repository_link, pictures_carousel: [], projects_stacks_attributes: [ :id, :stack_id, :_destroy ])
    end
end
